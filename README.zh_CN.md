...
const videoConfig = {
  ...
  height: 1080,
  framerate: 30,
  /** 除 macOS HEVC 软编不支持 `realtime` 模式外，硬件基本两种都支持，请根据实际需要设置 */
  latencyMode: 'quality',
  /** 
  ...
  /**
   * SVC 模式，当设置为 `L1T2` 时，仅 macOS14+ Arm64 机型或 Windows 部分 Intel 显卡机型支持
   */
